...
let heroBanner=function({results:movieList}){
...
<div class="slider-control">
  ...
  for(let [index,movie] of Object.entries(movieList)){
    let {
      backdrop_path,
      title,
      release_date,
    ...
    <div class="banner-content">
      ...
      <p class="banner-text">${overview}</p>
        <a onclick='getMovieDetail(${id})' href="./detail.html" class="btn">
    ...
    let controlItem=document.createElement('button');
...
let createMovieList=function({results:movieList},title){
